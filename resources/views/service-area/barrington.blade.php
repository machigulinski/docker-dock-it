...
@section('title', 'Local Plumbers | Barrington')

@section('description', 'Local plumbers, plumbing services near Barrington, IL. Trusted and reliable local plumber near Barrington, IL.
Call now 847-393-3733.')

@section('content')

    <div id="barrington_page" class="interior_page service_area_page">
        <a id="barrington-plumber"></a>
                        ...
                        <div class="small_banner">
                            <div class="inside_wrap">
                                <h1 class="column_heading main_heading">
                                    <u> Barrington IL </u>Local Plumbers &bull; Clogged Drains &bull; Plumbing Services
                                </h1>
                                <p class="text-center">
                                    Are you looking for a professional local plumber near the Barrington, IL area? <b>Maximum Plumbing</b> provides professional plumbing
                                    services in Barrington and all the surrounding areas.
                                </p>
                                    ...
                                    <div class="col-lg-6 column text_column">
                                        <div class="action_lead table_display">
                                            ...
                                            <div class="text_cell table_cell">
                                                ...
                                                <p class="service_description">Broken pipes, faucet, sink, and toilet leak repairs near <span class="d-inline-block">{{ $location['city_state'] }}</span></p>
                                            </div>
                                        </div>
                                        <div class="action_lead table_display">
                                            <div class="icon_cell table_cell">
                                            ...
                                            <div class="text_cell table_cell">
                                                ...
                                                <p class="service_description">We provide water heater installation and repair services near <span class="d-inline-block">{{ $location['city_state'] }}</span></p>
                                            </div>
                                        </div>
                                        <div class="action_lead table_display">
                                            <div class="icon_cell table_cell">
                                            ...
                                            <div class="text_cell table_cell">
                                                ...
                                                <p class="service_description">Sump pump with battery backup installations near <span class="d-inline-block">{{ $location['city_state'] }}</span></p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-6 column text_column">
                                        <div class="action_lead table_display">
                                            ...
                                            <div class="text_cell table_cell">
                                                ...
                                                <p class="service_description">Drain and sewer main line rodding, drain clog removal services near <span class="d-inline-block">{{ $location['city_state'] }}</span></p>
                                            </div>
                                        </div>
                                        <div class="action_lead table_display">
                                            <div class="icon_cell table_cell">
                                            ...
                                            <div class="text_cell table_cell">
                                                ...
                                                <p class="service_description">Installations and repair of all types of toilets, sinks, faucets, and bathtubs in <span class="d-inline-block">{{ $location['city_state'] }}</span></p>
                                            </div>
                                        </div>
                                        <div class="action_lead table_display">
                                            <div class="icon_cell table_cell">
                                            ...
                                            <div class="text_cell table_cell">
                                                ...
                                                <p class="service_description">Installations of quality kitchen garbage disposals near <span class="d-inline-block">{{ $location['city_state'] }}</span></p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
            ...
            <div class="content_wrap">
                <div class="row">
                    <div class="col-lg-8 column column_lg_left">
                        ...
                        <p>
                            <b>Maximum Plumbing, Inc.</b> provides residential and commercial plumbing services across the whole area of Barrington, IL.
                            We have professional plumbing equipment, experience, and know-how to take care of any plumbing issues or inquiries.
                        </p>
                        <br>
                        <div class="service_row">
                            <div class="row">
                                ...
                                <div class="col-lg-7 column text_wrap">
                                    <h2 class="paragraph_heading">Residential Plumbing Services | {{ $location['city_state'] }}</h2>
                                    <p>
                                        Maximum Plumbing, Inc. offers a full range of plumbing and drains cleaning services in Barrington, IL, and all the surrounding areas. We will quickly
                                        handle installations of all types of sump pumps, garbage disposals, faucets, or water heaters.
                                    </p>
                                    <p>
                                        Problem with pipe leaks? <a class="phone_link" title="Call Local Sump Pump Plumber in Lake Zurich, IL are" href="tel:1-{{ config('app.phone') }}">
                                            Call us now!
                                        </a> We will quickly locate and fix any pipe leaks preventing further damage to your property. Clogged drains? No problem, we have professional equipment
                                        to find and remove any obstructions in your drains or sewer main line.
                                    </p>
                                </div>
                            </div>
                            ...
                            <p>
                                ...
                                </a> and we will assist you shortly.
                            </p>
                        </div>
                        ...
                        <div class="service_row">
                            <div class="row">
                                <div class="col-lg-5 column column_lg_left">
                                    <div class="image_wrap">
                                        <img class="content_image" src="{{ asset('images/local-plumber-commercial-plumbing-services700x700.jpg') }}"
                                ...
                                <div class="col-lg-7 column text_wrap">
                                    ...
                                    <h2 class="paragraph_heading">Commercial Plumbing Services | <span class="d-inline-block">{{ $location['city_state'] }}</span></h2>
                                    <p>
                                        We are fully certified and experienced to handle any commercial plumbing job.
                                        Regardless of how big or small your project is we have the tools and skills to complete it promptly at an estimated cost.
                                    </p>
                                    <p>
                                        Call us if you are a business owner who needs a reliable plumber in the area of Barrington, IL.
                                    </p>
                                    <p>
                                        We offer unmatched work quality, free, straight-up cost estimates, and highly professional customer service.
                                    </p>
                                    <br>
                                </div>
                            </div>
                            <br>
                            <h2 class="paragraph_heading text-center mb-4">
                                Are you looking for a trusted plumber near the Barrington, IL area?
                            </h2>
                    ...
                    <div class="col-lg-4 column sidebar_right">
                        ...
                        <br>
                        <div class="image_wrap">
                            <img class="content_image" src="{{ asset('images/local-plumber-copper-pipes-plumbing-services700x700.jpg') }}"
            ...
            <div class="row map_wrapper">
                <div class="col-sm-12 column">
                    <div class="map_container">
                        <iframe class="responsive_map" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d25805.442911655206!2d-88.13860011964081!3d42.15110265933683!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x880fa0b43e24448d%3A0xeab163b72ecbdbbd!2sBarrington%2C%20IL%2060010!5e0!3m2!1sen!2sus!4v1628197182223!5m2!1sen!2sus" style="border:0;" allowfullscreen="" loading="lazy"></iframe>
                    </div>
                </div>
            </div>
        </section>
